...
class DataTransformation:
    ...
    def __init__(self, data_transformation_config: config_entity.DataTransformationConfig, data_ingestion_artifact: artifact_entity.DataIngestionArtifact) -> None:
        """This is also a constructor method, but it takes two parameters: data_transformation_config of type config_entity.DataTransformationConfig, and data_ingestion_artifact of type artifact_entity.DataIngestionArtifact."""
        try:
            self.data_transformation_config = data_transformation_config #This line assigns the data_transformation_config parameter to an instance variable self.data_transformation_config
